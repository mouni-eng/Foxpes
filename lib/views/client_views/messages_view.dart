                          ...
                          ? SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  CustomText(
                                      text: LocaleKeys.noMessages1.tr(),
                                      fontsize: 13.sp,
                                      color: kHintTextColor),
                                ],
                              ),
                              ...
                              itemBuilder: (context, index) => InkWell(
                                    onTap: () {
                                      Navigator.push(
                                          ...
                                          cubit.updateIsOpenedStatus(
                                              receiverId:
                                                  cubit.chatsList[index].uid!));
                                    },
                                    child: Container(
                                      width: double.infinity,
                                      height: height(90),
                                                          ...
                                                          cubit
                                                              ...
                                                              ? CustomText(
                                                                  ...
                                                                  fontsize:
                                                                      14.sp,
                                                                  height: 1,
                                                                  color: cubit.lastMessagesList[index].isOpened ==
                                                                          false
                                                                      ? kPrimaryColor
                                                                      : kHintTextColor)
                                                              : CustomText(
      ...
      builder: (context, state) {
        ...
        return ConditionalBuilder(
            ...
            builder: (context) => cubit
                            ...
                            .toString() !=
                        "0" &&
                    cubit.notOpenedMessages[cubit.chatsList[index].uid]
                            .toString() !=
                        "null"
                ? CircleAvatar(
                    radius: width(10),
